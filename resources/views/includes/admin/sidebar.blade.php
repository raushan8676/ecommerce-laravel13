<aside id="sidebar"
    ...
    <div class="flex items-center justify-center h-16 bg-sky-600 border-b border-gray-800">
        <a href="{{ route('home.index') }}"><img src="{{ asset('assets/images/ecommlogo3.png') }}" alt="Logo" class="h-20" /></a>
    </div>
