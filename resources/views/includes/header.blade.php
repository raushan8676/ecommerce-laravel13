        ...
        <div class="flex justify-between items-center">
            <div class="w-1/4">
                <a href="{{ route('home.index') }}">
                    <img src="{{ asset('assets/images/ecommlogo.png') }}" alt="Logo" class="max-w-[200px]" />
                </a>
            </div>
            ...
            <div class="w-1/2 flex justify-center">
                <nav>
                    <ul class="flex space-x-8 font-medium text-gray-700">
                        ...
                        <li><a href="{{ route('wishlist.index') }}" class="hover:text-primary transition">Wishlist</a>
                        </li>
            ...
            <div class="w-1/4 flex justify-end items-center space-x-6">
                ...
                <a href="{{ route('wishlist.index') }}" class="text-2xl hover:text-primary relative">
                    ...
                    <span
                        class="absolute -top-2 -right-2 bg-primary text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">{{ Cart::instance('wishlist')->count() }}</span>
                </a>

                <a href="{{ route('cart.index') }}" class="text-2xl hover:text-primary relative">
                    <i class="fa-solid fa-bag-shopping"></i>
                    <span
                        class="absolute -top-2 -right-2 bg-primary text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">{{ Cart::instance('cart')->count() }}</span>
                </a>
                    ...
                    <ul
                        ...
                        @guest
                            ...
                            <li><a href='{{ route('register') }}' class="block px-4 py-2 hover:bg-gray-100 text-sm">Sign
                                    Up</a></li>
                        @else
                            <li><a href='{{ Auth::user()->utype == 'admin' ? route('admin.index') : route('users.index') }}'
                                    class="block px-4 py-2 hover:bg-gray-100 text-sm">My Account</a></li>
                            <li>
                                <a href="{{ route('logout') }}"
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center space-x-5">
                <a href="{{ route('wishlist.index') }}" class="text-xl hover:text-primary relative">
                    <i class="fa-regular fa-heart"></i>
                    <span
                        class="absolute -top-2 -right-2 bg-primary text-white text-[10px] rounded-full w-4 h-4 flex items-center justify-center">{{ Cart::instance('wishlist')->count() }}</span>
                </a>

                <a href="{{ route('cart.index') }}" class="text-xl hover:text-primary relative">
                    <i class="fa-solid fa-bag-shopping"></i>
                    <span
                        class="absolute -top-2 -right-2 bg-primary text-white text-[10px] rounded-full w-4 h-4 flex items-center justify-center">{{ Cart::instance('cart')->count() }}</span>
                </a>
...
<div id="mobile-sidebar"
    ...
    <nav class="p-4">
        <ul class="space-y-4">
            ...
            <li><a href="#" class="block hover:text-primary">Contact</a></li>
        </ul>
    </nav>
</div>
